...
router.get('/map-tile/:latitude,:longitude', async (req, env, ctx) => {
	...
	const url = `https://api.mapbox.com/styles/v1/${style}/static/pin-l+ffffff(${longitude},${latitude})/${longitude},${latitude},5,0/600x400@2x?access_token=${env.MAPBOX_TOKEN}&logo=false`;
